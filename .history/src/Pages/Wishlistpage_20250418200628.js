...
const Wishlistpage = () => {
  ...
  const handleRemoveFromWishlist = async (bookId) => {
    try {
      ...
      setLocalError(err.response?.data?.message || 'Failed to remove from wishlist');
    }
  };
              ...
              <div key={item._id} className="wishlist-card">
                ...
                <div className="wishlist-card-content">
                  ...
                  <button
                    ...
                    className={`wishlist-remove-btn ${wishlist.some((book) => book && book._id === item._id) ? 'wished' : 'not-wished'}`}
                  >
